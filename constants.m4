...
def(PVM_JUMP,                       hex(80))
def(PVM_TRY,                        hex(81))
def(PVM_ACCEPT,                     hex(82))
def(PVM_FAIL,                       hex(83))
def(PVM_CALL,                       hex(84))
def(PVM_RETURN,                     hex(85))
def(PVM_BEGIN,                      hex(86))
def(PVM_TOKENIZE,                   hex(87))
def(PVM_DISPATCH,                   hex(88))
def(PVM_EMIT,                       hex(89))
def(PVM_COMPOSE,                    hex(81))
def(PVM_INT,                        hex(8B))
def(PVM_EOL,                        hex(8C))
def(PVM_WS,                         hex(8D))
def(PVM_ARGSEP,                     hex(8E))
