...
def(TOK_RUN,            hex(40))
def(TOK_PRINT,          hex(41))
def(TOK_ALT_PRINT,      hex(42))
def(TOK_LET,            hex(43))
def(TOK_LIST,           hex(44))
def(TOK_GOTO,           hex(45))
def(TOK_GOSUB,          hex(46))
def(TOK_RETURN,         hex(47))
def(TOK_POP,            hex(48))
def(TOK_ON,             hex(49))
def(TOK_FOR,            hex(4A))
def(TOK_NEXT,           hex(4B))
...
def(TOK_DATA,           hex(52))
def(TOK_READ,           hex(53))
def(TOK_RESTORE,        hex(54))
def(TOK_POKE,           hex(55))
def(TOK_DPOKE,          hex(56))
def(TOK_END,            hex(57))
...
def(TOK_ASC,            hex(83))
def(TOK_LEFT_S,         hex(84))
def(TOK_RIGHT_S,        hex(85))
def(TOK_MID_S,          hex(86))
def(TOK_VAL,            hex(87))
def(TOK_FRE,            hex(88))
def(TOK_PEEK,           hex(89))
def(TOK_DPEEK,          hex(8A))
def(TOK_ADR,            hex(8B))
def(TOK_USR,            hex(8C))
def(TOK_INT,            hex(8D))
def(TOK_LOG,            hex(8E))
...
def(TOK_CLASS_OP_2X,    hex(02))
def(TOK_CLASS_OP_3X,    hex(03))
def(TOK_CLASS_ST_4X,    hex(04))
def(TOK_CLASS_ST_5X,    hex(05))
def(TOK_CLASS_ST_6X,    hex(06))
def(TOK_CLASS_ST_7X,    hex(07))
def(TOK_CLASS_FN_8X,    hex(08))
def(TOK_CLASS_FN_9X,    hex(09))
def(TOK_CLASS_FN_AX,    hex(0A))
def(TOK_CLASS_FN_BX,    hex(0B))
