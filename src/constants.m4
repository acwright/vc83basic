...
def(TOK_LEN,            hex(41))
def(TOK_STR_S,          hex(42))
def(TOK_CHR_S,          hex(43))
def(TOK_ASC,            hex(44))
def(TOK_LEFT_S,         hex(45))
def(TOK_RIGHT_S,        hex(46))
def(TOK_MID_S,          hex(47))
def(TOK_VAL,            hex(48))
def(TOK_FRE,            hex(49))
def(TOK_PEEK,           hex(4A))
def(TOK_DPEEK,          hex(4B))
def(TOK_ADR,            hex(4C))
def(TOK_USR,            hex(4D))
def(TOK_INT,            hex(4E))
def(TOK_LOG,            hex(4F))
...
def(TOK_LIST,           hex(85))
def(TOK_GOTO,           hex(86))
def(TOK_GOSUB,          hex(87))
def(TOK_RETURN,         hex(88))
def(TOK_POP,            hex(89))
def(TOK_ON,             hex(8A))
def(TOK_FOR,            hex(8B))
def(TOK_NEXT,           hex(8C))
...
def(TOK_DATA,           hex(94))
def(TOK_READ,           hex(95))
def(TOK_RESTORE,        hex(96))
def(TOK_POKE,           hex(97))
def(TOK_DPOKE,          hex(98))
def(TOK_END,            hex(99))
...
def(PVM_FAIL,                       hex(F1))
def(PVM_GUARD,                      hex(F2))
def(PVM_SLURP,                      hex(F3))
