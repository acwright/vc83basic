...
def(TOK_CLASS_OP_3X,    hex(30))
def(TOK_CLASS_ST_4X,    hex(40))
def(TOK_CLASS_ST_5X,    hex(50))
def(TOK_CLASS_ST_6X,    hex(60))
def(TOK_CLASS_ST_7X,    hex(70))
def(TOK_CLASS_FN_8X,    hex(80))
def(TOK_CLASS_FN_9X,    hex(90))
def(TOK_CLASS_FN_AX,    hex(A0))
def(TOK_CLASS_FN_BX,    hex(B0))
