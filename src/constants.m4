...
def(TOK_NOT,            hex(82))
def(TOK_LET,            hex(83))
def(TOK_IMPL_LET,       hex(84))
def(TOK_RUN,            hex(85))
def(TOK_PRINT,          hex(86))
def(TOK_ALT_PRINT,      hex(87))
def(TOK_LIST,           hex(88))
def(TOK_GOTO,           hex(89))
def(TOK_IMPL_GOTO,      hex(8A))
def(TOK_GOSUB,          hex(8B))
def(TOK_RETURN,         hex(8C))
def(TOK_POP,            hex(8D))
def(TOK_ON,             hex(8E))
def(TOK_FOR,            hex(8F))
def(TOK_NEXT,           hex(90))
...
def(TOK_DATA,           hex(97))
def(TOK_READ,           hex(98))
def(TOK_RESTORE,        hex(99))
def(TOK_POKE,           hex(9A))
def(TOK_DPOKE,          hex(9B))
def(TOK_END,            hex(9C))
def(TOK_INPUT,          hex(9D))
def(TOK_IF_THEN,        hex(9E))
