...
| `$C0-$CF` | 1 | 1 | 1 | 1 | c | c | c | c | MATCH_CLASS | 1 | - |
| `$D0-$D3`  | 1 | 1 | 0 | 0 | 0 | 0 | h | h | CALL | 2 | `llllllll` |
| `$D4-$D7`  | 1 | 1 | 0 | 0 | 0 | 1 | h | h | JUMP | 2 | `llllllll` |
| `$D8-$DB`  | 1 | 1 | 0 | 0 | 1 | 0 | h | h | BRANCH_IF | 3 | `llllllll`, `tttttttt` |
| `$F0` | 1 | 1 | 0 | 1 | 0 | 0 | 0 | 0 | RETURN | 1 | - |
| `$F1` | 1 | 1 | 0 | 1 | 0 | 0 | 0 | 1 | GUARD | 2 | `tttttttt` |
| `$F2` | 1 | 1 | 0 | 1 | 0 | 0 | 1 | 0 | SLURP | 1 | - |
| `$FF` | 1 | 1 | 0 | 1 | 1 | 1 | 1 | 1 | FAIL | 1 | - |
