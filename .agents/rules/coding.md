...
Spaces around operators in expressions follow a semantic convention. Address and offset calculations have **no spaces**: `var_ptr+1`, `Line::num+1`, `stack+Control::next_line_ptr,x`, `.word exec_print-1`, `#'A'-1`. Value computations have **spaces**: `#.sizeof(Line) + 2`, `1 | PROLOG_POP_FP`, `* - ready_message`, `fp_scratch + .sizeof(Float) * 2`, `.if fp_format = 5`. The distinction is whether the expression represents a location in memory (tight) or computes a value (spaced).
