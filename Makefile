...
COMMON_SOURCES = decode.s encode.s input.s let.s list.s main.s name.s parser.s print.s program.s run.s tables.s util.s
COMMON_OBJECTS = $(COMMON_SOURCES:.s=.o)

TESTS = decode_test encode_test list_test name_test parser_test program_test util_test
